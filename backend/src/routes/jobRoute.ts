...
import { getAllJobs, createPost, updatePost, deletePost, createJobPost, editJobPost,deleteJobPost, getAllJobPosts, getMyPosts,getMyJobPosts } from "../controllers/jobController";
